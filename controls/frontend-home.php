	...
	<?php 
		...
		else
		{
			...
			?>
				...
				<p><?php _e("Please ", "bravowp-helpdesk");?> <a href="<?php echo wp_login_url(); ?>" title="Login"><?php _e("Login", "bravowp-helpdesk");?></a> <?php _e("or", "bravowp-helpdesk");?> <a href="<?php echo wp_registration_url(); ?>" title="Register"><?php _e("Register", "bravowp-helpdesk");?></a> <?php _e("to our website. Thank you!", "bravowp-helpdesk");?></p>

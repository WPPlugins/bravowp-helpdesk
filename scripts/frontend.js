	...
	(
		{
			...
			data : 
				{
					action : 'ajax_frontend_ticket_list',
	...
	(
		{
			...
			data : 
				{
					action : 'ajax_frontend_loadticketeditpage',
					security : bwhdVars.ajaxNonce,
			...
			success : function( response ) 
			{
				...
				jQuery("#bwhd-frontend-controls-ticketedit-spanstatus").text( response.status_description );
	...
	(
		{
			...
			data : 
				{
					action : 'ajax_frontend_loadmessageseditpage',
					security : bwhdVars.ajaxNonce,
					ticket_id : value_ticket_id
				},
			success : function( response ) 
	...
	(
		{
			...
			data : 
				{
					action : 'ajax_frontend_message_save',
					security : bwhdVars.ajaxNonce,
					ticket_id : value_ticket_id,
	...
	(
		{
			...
			data : 
				{
					action : 'ajax_frontend_ticket_insert',
					security : bwhdVars.ajaxNonce,
